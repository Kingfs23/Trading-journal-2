...
form.addEventListener("submit", async (event) => {
  ...
  try {
    beforeDataUrl = await fileToDataUrl(beforeFile);
    afterDataUrl = await fileToDataUrl(afterFile);
  } catch (error) {
    console.error(error);
    setStatus("Could not read one of the images. Try a smaller screenshot.", "error");
    isSaving = false;
  ...
  const trade = {
    ...
    before_local_url: beforeDataUrl,
    after_local_url: afterDataUrl,
    sync_status: "local",
  };
  ...
  try {
    ...
    delete dbTrade.before_local_url;
    delete dbTrade.after_local_url;
    delete dbTrade.before_url;
    delete dbTrade.after_url;
    ...
    saveLocalTrade({
      ...
      before_local_url: trade.before_local_url,
      after_local_url: trade.after_local_url,
      sync_status: "synced",
    });
